...
Citizen.CreateThread(function()
    while true do
        ...
        AddTextEntry('FE_THDR_GTAO', "~b~FreeLife - Officiel ~m~| ~b~discord.gg/~w~freelife ~m~| ~b~ID : ~w~".. GetPlayerServerId(PlayerId()) .." ~m~| ~b~".. nbPlayerTotal .. "~w~/~b~999 ~w~joueurs ~b~en ligne")
